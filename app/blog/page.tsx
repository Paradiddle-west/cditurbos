    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="py-12 bg-gray-50">
          <div className="container">
            <h2 className="text-2xl font-bold mb-8 text-[#093C8E] font-oxanium">Artículos Recientes</h2>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-md transition-transform hover:shadow-lg hover:-translate-y-1">
                <div className="relative h-48">
                  <Image
                    src="/turbo-installation-guide.png"
                    alt="Guía paso a paso: Instalación de un turbocompresor"
                    fill
                    className="object-cover"
                  />
                  <div className="absolute top-4 left-4 bg-[#E5262D] text-white text-xs font-semibold px-2 py-1 rounded">
                ...
                <div className="p-6">
                  <p className="text-sm text-gray-500 mb-2 font-roboto">10 de Abril, 2025</p>
                  <h3 className="text-xl font-bold mb-3 text-[#093C8E] font-oxanium">
                    Guía paso a paso: Instalación de un turbocompresor
                  </h3>
                  <p className="text-[#03255C] mb-4 line-clamp-3 font-roboto">
                    Aprende cómo instalar correctamente un turbocompresor en tu vehículo con esta guía detallada.
                    Incluye consejos de profesionales y errores comunes a evitar.
                  </p>
                  <Link
                    href="/blog/guia-instalacion-turbocompresor"
                    className="inline-flex items-center text-[#019FD5] hover:text-[#093C8E] font-medium"
                  >
                    Leer más
                    <ChevronRight className="ml-1 h-4 w-4" />
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-md transition-transform hover:shadow-lg hover:-translate-y-1">
                <div className="relative h-48">
                  <Image
                    src="/turbo-efficiency-boost.png"
                    alt="Cómo aumentar la eficiencia de tu turbocompresor"
                    fill
                    className="object-cover"
                  />
                  <div className="absolute top-4 left-4 bg-[#019FD5] text-white text-xs font-semibold px-2 py-1 rounded">
                ...
                <div className="p-6">
                  <p className="text-sm text-gray-500 mb-2 font-roboto">5 de Abril, 2025</p>
                  <h3 className="text-xl font-bold mb-3 text-[#093C8E] font-oxanium">
                    Cómo aumentar la eficiencia de tu turbocompresor
                  </h3>
                  <p className="text-[#03255C] mb-4 line-clamp-3 font-roboto">
                    Descubre técnicas y modificaciones que pueden ayudarte a obtener el máximo rendimiento de tu
                    turbocompresor sin comprometer su durabilidad.
                  </p>
                  <Link
                    href="/blog/aumentar-eficiencia-turbocompresor"
                    className="inline-flex items-center text-[#019FD5] hover:text-[#093C8E] font-medium"
                  >
                    Leer más
                    <ChevronRight className="ml-1 h-4 w-4" />
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-md transition-transform hover:shadow-lg hover:-translate-y-1">
                <div className="relative h-48">
                  <Image
                    src="/turbo-vs-supercharger.png"
                    alt="Turbocompresor vs. Supercargador: ¿Cuál es mejor para tu vehículo?"
                    fill
                    className="object-cover"
                  />
                  <div className="absolute top-4 left-4 bg-[#093C8E] text-white text-xs font-semibold px-2 py-1 rounded">
                ...
                <div className="p-6">
                  <p className="text-sm text-gray-500 mb-2 font-roboto">28 de Marzo, 2025</p>
                  <h3 className="text-xl font-bold mb-3 text-[#093C8E] font-oxanium">
                    Turbocompresor vs. Supercargador: ¿Cuál es mejor?
                  </h3>
                  <p className="text-[#03255C] mb-4 line-clamp-3 font-roboto">
                    Analizamos las diferencias, ventajas y desventajas entre turbocompresores y supercargadores para
                    ayudarte a decidir cuál es la mejor opción para tu vehículo.
                  </p>
                  <Link
                    href="/blog/turbocompresor-vs-supercargador"
                    className="inline-flex items-center text-[#019FD5] hover:text-[#093C8E] font-medium"
                  >
                    Leer más
                    <ChevronRight className="ml-1 h-4 w-4" />
            ...
            <div className="flex justify-center mt-12">
              <div className="flex items-center gap-2">
                ...
                <Button variant="outline" className="bg-[#093C8E] text-white hover:bg-[#019FD5]">
                  1
                </Button>
        ...
        <section className="py-12">
          <div className="container">
            <h2 className="text-2xl font-bold mb-8 text-[#093C8E] font-oxanium">Categorías</h2>

            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              <Link
                href="/blog/categoria/guias"
                className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-all border border-gray-100 text-center"
              >
                <div className="w-12 h-12 bg-[#DBF6FF] rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-[#019FD5] font-bold">G</span>
                </div>
                <h3 className="font-bold text-[#093C8E] font-oxanium">Guías</h3>
                <p className="text-sm text-gray-600 mt-1 font-roboto">12 artículos</p>
              </Link>
              ...
              >
                <div className="w-12 h-12 bg-[#DBF6FF] rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-[#019FD5] font-bold">M</span>
                </div>
                <h3 className="font-bold text-[#093C8E] font-oxanium">Mantenimiento</h3>
                <p className="text-sm text-gray-600 mt-1 font-roboto">8 artículos</p>
              </Link>
              ...
              >
                <div className="w-12 h-12 bg-[#DBF6FF] rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-[#019FD5] font-bold">R</span>
                </div>
                <h3 className="font-bold text-[#093C8E] font-oxanium">Rendimiento</h3>
                <p className="text-sm text-gray-600 mt-1 font-roboto">10 artículos</p>
              </Link>

              <Link
                href="/blog/categoria/comparativas"
                className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-all border border-gray-100 text-center"
              >
                <div className="w-12 h-12 bg-[#DBF6FF] rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-[#019FD5] font-bold">C</span>
                </div>
                <h3 className="font-bold text-[#093C8E] font-oxanium">Comparativas</h3>
                <p className="text-sm text-gray-600 mt-1 font-roboto">6 artículos</p>
              </Link>
            </div>
          </div>
        </section>
